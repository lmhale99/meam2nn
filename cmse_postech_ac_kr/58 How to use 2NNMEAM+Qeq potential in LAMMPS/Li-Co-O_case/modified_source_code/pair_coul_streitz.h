...
class PairCoulStreitz : public Pair {
 ...
 protected:
  struct Param {
    double chi, eta, de2, de3, de4, gamma, zeta, zcore, pen;	// @@@
	double e1,x1,j1,e2,x2,j2,e3,x3,j3,e4,x4,j4;					// @@@
    int ielement;
  };
  ...
  // QEq
  double *qeq_x1, *qeq_j1, *qeq_x2, *qeq_j2, *qeq_x3, *qeq_j3, *qeq_x4, *qeq_j4,	// @@@
		 *qeq_g, *qeq_z, *qeq_c, *qeq_p;											// @@@
