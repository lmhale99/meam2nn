...
//  if ((nevery <= 0) || (cutoff <= 0.0) || (tolerance <= 0.0) || (maxiter <= 0))	
  ...
  if (strcmp(arg[8],"coul/streitz") == 0) {
    streitz_flag = 1;
  } else {
    read_file(arg[8]);
  }
